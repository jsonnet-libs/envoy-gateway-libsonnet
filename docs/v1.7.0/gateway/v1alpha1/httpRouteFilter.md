---
permalink: /v1.7.0/gateway/v1alpha1/httpRouteFilter/
---
...
* [`obj spec`](#obj-spec)
  ...
  * [`obj spec.directResponse`](#obj-specdirectresponse)
    ...
    * [`obj spec.directResponse.header`](#obj-specdirectresponseheader)
      * [`fn withAdd(add)`](#fn-specdirectresponseheaderwithadd)
      * [`fn withAddMixin(add)`](#fn-specdirectresponseheaderwithaddmixin)
      * [`fn withRemove(remove)`](#fn-specdirectresponseheaderwithremove)
      * [`fn withRemoveMixin(remove)`](#fn-specdirectresponseheaderwithremovemixin)
      * [`fn withSet(set)`](#fn-specdirectresponseheaderwithset)
      * [`fn withSetMixin(set)`](#fn-specdirectresponseheaderwithsetmixin)
      * [`obj spec.directResponse.header.add`](#obj-specdirectresponseheaderadd)
        * [`fn withName(name)`](#fn-specdirectresponseheaderaddwithname)
        * [`fn withValue(value)`](#fn-specdirectresponseheaderaddwithvalue)
      * [`obj spec.directResponse.header.set`](#obj-specdirectresponseheaderset)
        * [`fn withName(name)`](#fn-specdirectresponseheadersetwithname)
        * [`fn withValue(value)`](#fn-specdirectresponseheadersetwithvalue)
  * [`obj spec.matches`](#obj-specmatches)
    * [`fn withCookies(cookies)`](#fn-specmatcheswithcookies)
    * [`fn withCookiesMixin(cookies)`](#fn-specmatcheswithcookiesmixin)
    * [`obj spec.matches.cookies`](#obj-specmatchescookies)
      * [`fn withName(name)`](#fn-specmatchescookieswithname)
      * [`fn withType(type)`](#fn-specmatchescookieswithtype)
      * [`fn withValue(value)`](#fn-specmatchescookieswithvalue)
...
## obj spec.directResponse.header

"Header defines the headers of the direct response."

### fn spec.directResponse.header.withAdd
...
### fn spec.directResponse.header.withAddMixin
...
### fn spec.directResponse.header.withRemove
...
### fn spec.directResponse.header.withRemoveMixin
...
### fn spec.directResponse.header.withSet
...
### fn spec.directResponse.header.withSetMixin
...
## obj spec.directResponse.header.add

"Add adds the given header(s) (name, value) to the request\nbefore the action. It appends to any existing values associated\nwith the header name.\n\nInput:\n  GET /foo HTTP/1.1\n  my-header: foo\n\nConfig:\n  add:\n  - name: \"my-header\"\n    value: \"bar,baz\"\n\nOutput:\n  GET /foo HTTP/1.1\n  my-header: foo,bar,baz"

### fn spec.directResponse.header.add.withName
...
### fn spec.directResponse.header.add.withValue
...
## obj spec.directResponse.header.set

"Set overwrites the request with the given header (name, value)\nbefore the action.\n\nInput:\n  GET /foo HTTP/1.1\n  my-header: foo\n\nConfig:\n  set:\n  - name: \"my-header\"\n    value: \"bar\"\n\nOutput:\n  GET /foo HTTP/1.1\n  my-header: bar"

### fn spec.directResponse.header.set.withName
...
### fn spec.directResponse.header.set.withValue
...
### fn spec.matches.withCookiesMixin
...
## obj spec.matches.cookies

"Cookies is a list of cookie matchers evaluated against the HTTP request.\nAll specified matchers must match."

### fn spec.matches.cookies.withName
...
### fn spec.matches.cookies.withType
...
### fn spec.matches.cookies.withValue
