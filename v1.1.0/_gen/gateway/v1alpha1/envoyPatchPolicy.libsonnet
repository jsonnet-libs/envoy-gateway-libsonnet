{
  ...
  '#':: d.pkg(name='envoyPatchPolicy', url='', help='"EnvoyPatchPolicy allows the user to modify the generated Envoy xDS\\nresources by Envoy Gateway using this patch API"'),
  ...
  spec: {
    ...
    jsonPatches: {
      ...
      operation: {
        ...
        '#withPath':: d.fn(help='"Path is the location of the target document/field where the operation will be performed\\nRefer to https://datatracker.ietf.org/doc/html/rfc6901 for more details."', args=[d.arg(name='path', type=d.T.string)]),
    ...
    '#targetRef':: d.obj(help='"TargetRef is the name of the Gateway API resource this policy\\nis being attached to.\\nBy default, attaching to Gateway is supported and\\nwhen mergeGateways is enabled it should attach to GatewayClass.\\nThis Policy and the TargetRef MUST be in the same namespace\\nfor this Policy to have effect and be applied to the Gateway\\nTargetRef"'),
    targetRef: {
    ...
    '#withPriority':: d.fn(help='"Priority of the EnvoyPatchPolicy.\\nIf multiple EnvoyPatchPolicies are applied to the same\\nTargetRef, they will be applied in the ascending order of\\nthe priority i.e. int32.min has the highest priority and\\nint32.max has the lowest priority.\\nDefaults to 0."', args=[d.arg(name='priority', type=d.T.integer)]),
    withPriority(priority): { spec+: { priority: priority } },
    '#withType':: d.fn(help='"Type decides the type of patch.\\nValid EnvoyPatchType values are \\"JSONPatch\\"."', args=[d.arg(name='type', type=d.T.string)]),
