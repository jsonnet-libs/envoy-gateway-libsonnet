{
  ...
  spec: {
    ...
    bootstrap: {
      '#withType':: d.fn(help='"Type is the type of the bootstrap configuration, it should be either Replace or Merge.\\nIf unspecified, it defaults to Replace."', args=[d.arg(name='type', type=d.T.string)]),
    ...
    provider: {
      ...
      kubernetes: {
        ...
        envoyPDB: {
          '#withMinAvailable':: d.fn(help='"MinAvailable specifies the minimum number of pods that must be available at all times during voluntary disruptions,\\nsuch as node drains or updates. This setting ensures that your envoy proxy maintains a certain level of availability\\nand resilience during maintenance operations."', args=[d.arg(name='minAvailable', type=d.T.integer)]),
    ...
    telemetry: {
      ...
      accessLog: {
        ...
        settings: {
          ...
          sinks: {
            ...
            als: {
              '#backendRefs':: d.obj(help='"BackendRefs references a Kubernetes object that represents the gRPC service to which\\nthe access logs will be sent. Currently only Service is supported."'),
              backendRefs: {
                '#withGroup':: d.fn(help='"Group is the group of the referent. For example, \\"gateway.networking.k8s.io\\".\\nWhen unspecified or empty string, core API group is inferred."', args=[d.arg(name='group', type=d.T.string)]),
              ...
              '#withBackendRefs':: d.fn(help='"BackendRefs references a Kubernetes object that represents the gRPC service to which\\nthe access logs will be sent. Currently only Service is supported."', args=[d.arg(name='backendRefs', type=d.T.array)]),
              withBackendRefs(backendRefs): { als+: { backendRefs: if std.isArray(v=backendRefs) then backendRefs else [backendRefs] } },
              '#withBackendRefsMixin':: d.fn(help='"BackendRefs references a Kubernetes object that represents the gRPC service to which\\nthe access logs will be sent. Currently only Service is supported."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='backendRefs', type=d.T.array)]),
      ...
      tracing: {
        ...
        '#withSamplingRate':: d.fn(help='"SamplingRate controls the rate at which traffic will be\\nselected for tracing if no prior sampling decision has been made.\\nDefaults to 100, valid values [0-100]. 100 indicates 100% sampling."', args=[d.arg(name='samplingRate', type=d.T.integer)]),
