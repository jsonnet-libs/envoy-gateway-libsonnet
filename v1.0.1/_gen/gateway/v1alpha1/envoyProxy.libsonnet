{
  ...
  spec: {
    '#bootstrap':: d.obj(help='"Bootstrap defines the Envoy Bootstrap as a YAML string. Visit https://www.envoyproxy.io/docs/envoy/latest/api-v3/config/bootstrap/v3/bootstrap.proto#envoy-v3-api-msg-config-bootstrap-v3-bootstrap to learn more about the syntax. If set, this is the Bootstrap configuration used for the managed Envoy Proxy fleet instead of the default Bootstrap configuration set by Envoy Gateway. Some fields within the Bootstrap that are required to communicate with the xDS Server (Envoy Gateway) and receive xDS resources from it are not configurable and will result in the `EnvoyProxy` resource being rejected. Backward compatibility across minor versions is not guaranteed. We strongly recommend using `egctl x translate` to generate a `EnvoyProxy` resource with the `Bootstrap` field set to the default Bootstrap configuration used. You can edit this configuration, and rerun `egctl x translate` to ensure there are no validation errors."'),
    bootstrap: {
      '#withType':: d.fn(help='"Type is the type of the bootstrap configuration, it should be either Replace or Merge. If unspecified, it defaults to Replace."', args=[d.arg(name='type', type=d.T.string)]),
    ...
    logging: {
      '#withLevel':: d.fn(help='"Level is a map of logging level per component, where the component is the key and the log level is the value. If unspecified, defaults to \\"default: warn\\"."', args=[d.arg(name='level', type=d.T.object)]),
      withLevel(level): { spec+: { logging+: { level: level } } },
      '#withLevelMixin':: d.fn(help='"Level is a map of logging level per component, where the component is the key and the log level is the value. If unspecified, defaults to \\"default: warn\\"."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='level', type=d.T.object)]),
      withLevelMixin(level): { spec+: { logging+: { level+: level } } },
    },
    '#provider':: d.obj(help='"Provider defines the desired resource provider and provider-specific configuration. If unspecified, the \\"Kubernetes\\" resource provider is used with default configuration parameters."'),
    provider: {
      '#kubernetes':: d.obj(help='"Kubernetes defines the desired state of the Kubernetes resource provider. Kubernetes provides infrastructure resources for running the data plane, e.g. Envoy proxy. If unspecified and type is \\"Kubernetes\\", default settings for managed Kubernetes resources are applied."'),
      kubernetes: {
        '#envoyDeployment':: d.obj(help='"EnvoyDeployment defines the desired state of the Envoy deployment resource. If unspecified, default settings for the managed Envoy deployment resource are applied."'),
        envoyDeployment: {
          ...
          container: {
            ...
            '#resources':: d.obj(help='"Resources required by this container. More info: https://kubernetes.io/docs/concepts/configuration/manage-resources-containers/"'),
            resources: {
            ...
            '#volumeMounts':: d.obj(help="\"VolumeMounts are volumes to mount into the container's filesystem. Cannot be updated.\""),
            volumeMounts: {
            ...
            '#withVolumeMounts':: d.fn(help="\"VolumeMounts are volumes to mount into the container's filesystem. Cannot be updated.\"", args=[d.arg(name='volumeMounts', type=d.T.array)]),
          ...
          '#initContainers':: d.obj(help='"List of initialization containers belonging to the pod. More info: https://kubernetes.io/docs/concepts/workloads/pods/init-containers/"'),
          initContainers: {
          ...
          pod: {
            ...
            affinity: {
              ...
              podAffinity: {
                ...
                preferredDuringSchedulingIgnoredDuringExecution: {
                  ...
                  podAffinityTerm: {
                    '#labelSelector':: d.obj(help="\"A label query over a set of resources, in this case pods. If it's null, this PodAffinityTerm matches with no Pods.\""),
                    labelSelector: {
            ...
            '#volumes':: d.obj(help='"Volumes that can be mounted by containers belonging to the pod. More info: https://kubernetes.io/docs/concepts/storage/volumes"'),
            volumes: {
              ...
              projected: {
                ...
                sources: {
                  '#clusterTrustBundle':: d.obj(help='"ClusterTrustBundle allows a pod to access the `.spec.trustBundle` field of ClusterTrustBundle objects in an auto-updating file. \\n Alpha, gated by the ClusterTrustBundleProjection feature gate. \\n ClusterTrustBundle objects can either be selected by name, or by the combination of signer name and a label selector. \\n Kubelet performs aggressive normalization of the PEM contents written into the pod filesystem.  Esoteric PEM features such as inter-block comments and block headers are stripped.  Certificates are deduplicated. The ordering of certificates within the file is arbitrary, and Kubelet may change the order over time."'),
                  clusterTrustBundle: {
                    '#labelSelector':: d.obj(help='"Select all ClusterTrustBundles that match this label selector.  Only has effect if signerName is set.  Mutually-exclusive with name.  If unset, interpreted as \\"match nothing\\".  If set but empty, interpreted as \\"match everything\\"."'),
                    labelSelector: {
                      '#matchExpressions':: d.obj(help='"matchExpressions is a list of label selector requirements. The requirements are ANDed."'),
                      matchExpressions: {
                        '#withKey':: d.fn(help='"key is the label key that the selector applies to."', args=[d.arg(name='key', type=d.T.string)]),
            ...
            '#withAnnotations':: d.fn(help='"Annotations are the annotations that should be appended to the pods. By default, no pod annotations are appended."', args=[d.arg(name='annotations', type=d.T.object)]),
            withAnnotations(annotations): { spec+: { provider+: { kubernetes+: { envoyDeployment+: { pod+: { annotations: annotations } } } } } },
            '#withAnnotationsMixin':: d.fn(help='"Annotations are the annotations that should be appended to the pods. By default, no pod annotations are appended."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='annotations', type=d.T.object)]),
            ...
            '#withLabels':: d.fn(help='"Labels are the additional labels that should be tagged to the pods. By default, no additional pod labels are tagged."', args=[d.arg(name='labels', type=d.T.object)]),
            withLabels(labels): { spec+: { provider+: { kubernetes+: { envoyDeployment+: { pod+: { labels: labels } } } } } },
            '#withLabelsMixin':: d.fn(help='"Labels are the additional labels that should be tagged to the pods. By default, no additional pod labels are tagged."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='labels', type=d.T.object)]),
            ...
            '#withVolumes':: d.fn(help='"Volumes that can be mounted by containers belonging to the pod. More info: https://kubernetes.io/docs/concepts/storage/volumes"', args=[d.arg(name='volumes', type=d.T.array)]),
            ...
            '#withVolumesMixin':: d.fn(help='"Volumes that can be mounted by containers belonging to the pod. More info: https://kubernetes.io/docs/concepts/storage/volumes"\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='volumes', type=d.T.array)]),
          ...
          '#withInitContainers':: d.fn(help='"List of initialization containers belonging to the pod. More info: https://kubernetes.io/docs/concepts/workloads/pods/init-containers/"', args=[d.arg(name='initContainers', type=d.T.array)]),
          ...
          '#withInitContainersMixin':: d.fn(help='"List of initialization containers belonging to the pod. More info: https://kubernetes.io/docs/concepts/workloads/pods/init-containers/"\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='initContainers', type=d.T.array)]),
        ...
        '#envoyHpa':: d.obj(help='"EnvoyHpa defines the Horizontal Pod Autoscaler settings for Envoy Proxy Deployment. Once the HPA is being set, Replicas field from EnvoyDeployment will be ignored."'),
        envoyHpa: {
          '#behavior':: d.obj(help='"behavior configures the scaling behavior of the target in both Up and Down directions (scaleUp and scaleDown fields respectively). If not set, the default HPAScalingRules for scale up and scale down are used. See k8s.io.autoscaling.v2.HorizontalPodAutoScalerBehavior."'),
          behavior: {
          ...
          '#metrics':: d.obj(help='"metrics contains the specifications for which to use to calculate the desired replica count (the maximum replica count across all metrics will be used). If left empty, it defaults to being based on CPU utilization with average on 80% usage."'),
          metrics: {
            '#containerResource':: d.obj(help='"containerResource refers to a resource metric (such as those specified in requests and limits) known to Kubernetes describing a single container in each pod of the current scale target (e.g. CPU or memory). Such metrics are built in to Kubernetes, and have special scaling options on top of those available to normal per-pod metrics using the \\"pods\\" source. This is an alpha feature and can be enabled by the HPAContainerMetrics feature flag."'),
            containerResource: {
              ...
              target: {
                ...
                '#withAverageValue':: d.fn(help='"averageValue is the target value of the average of the metric across all relevant pods (as a quantity)"', args=[d.arg(name='averageValue', type=d.T.any)]),
            ...
            '#external':: d.obj(help='"external refers to a global metric that is not associated with any Kubernetes object. It allows autoscaling based on information coming from components running outside of cluster (for example length of queue in cloud messaging service, or QPS from loadbalancer running outside of cluster)."'),
            external: {
              '#metric':: d.obj(help='"metric identifies the target metric by name and selector"'),
              metric: {
                '#selector':: d.obj(help='"selector is the string-encoded form of a standard kubernetes label selector for the given metric When set, it is passed as an additional parameter to the metrics server for more specific metrics scoping. When unset, just the metricName will be used to gather metrics."'),
                selector: {
                  '#matchExpressions':: d.obj(help='"matchExpressions is a list of label selector requirements. The requirements are ANDed."'),
                  matchExpressions: {
                    '#withKey':: d.fn(help='"key is the label key that the selector applies to."', args=[d.arg(name='key', type=d.T.string)]),
            ...
            '#object':: d.obj(help='"object refers to a metric describing a single kubernetes object (for example, hits-per-second on an Ingress object)."'),
            object: {
            ...
            '#pods':: d.obj(help='"pods refers to a metric describing each pod in the current scale target (for example, transactions-processed-per-second).  The values will be averaged together before being compared to the target value."'),
            pods: {
              '#metric':: d.obj(help='"metric identifies the target metric by name and selector"'),
              metric: {
                '#selector':: d.obj(help='"selector is the string-encoded form of a standard kubernetes label selector for the given metric When set, it is passed as an additional parameter to the metrics server for more specific metrics scoping. When unset, just the metricName will be used to gather metrics."'),
            ...
            '#resource':: d.obj(help='"resource refers to a resource metric (such as those specified in requests and limits) known to Kubernetes describing each pod in the current scale target (e.g. CPU or memory). Such metrics are built in to Kubernetes, and have special scaling options on top of those available to normal per-pod metrics using the \\"pods\\" source."'),
            resource: {
              '#target':: d.obj(help='"target specifies the target value for the given metric"'),
              target: {
                '#withAverageUtilization':: d.fn(help='"averageUtilization is the target value of the average of the resource metric across all relevant pods, represented as a percentage of the requested value of the resource for the pods. Currently only valid for Resource metric source type"', args=[d.arg(name='averageUtilization', type=d.T.integer)]),
          ...
          '#withMetrics':: d.fn(help='"metrics contains the specifications for which to use to calculate the desired replica count (the maximum replica count across all metrics will be used). If left empty, it defaults to being based on CPU utilization with average on 80% usage."', args=[d.arg(name='metrics', type=d.T.array)]),
          withMetrics(metrics): { spec+: { provider+: { kubernetes+: { envoyHpa+: { metrics: if std.isArray(v=metrics) then metrics else [metrics] } } } } },
          '#withMetricsMixin':: d.fn(help='"metrics contains the specifications for which to use to calculate the desired replica count (the maximum replica count across all metrics will be used). If left empty, it defaults to being based on CPU utilization with average on 80% usage."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='metrics', type=d.T.array)]),
          withMetricsMixin(metrics): { spec+: { provider+: { kubernetes+: { envoyHpa+: { metrics+: if std.isArray(v=metrics) then metrics else [metrics] } } } } },
          '#withMinReplicas':: d.fn(help='"minReplicas is the lower limit for the number of replicas to which the autoscaler can scale down. It defaults to 1 replica."', args=[d.arg(name='minReplicas', type=d.T.integer)]),
          withMinReplicas(minReplicas): { spec+: { provider+: { kubernetes+: { envoyHpa+: { minReplicas: minReplicas } } } } },
        },
        '#envoyService':: d.obj(help='"EnvoyService defines the desired state of the Envoy service resource. If unspecified, default settings for the managed Envoy service resource are applied."'),
        envoyService: {
          ...
          '#withAnnotations':: d.fn(help='"Annotations that should be appended to the service. By default, no annotations are appended."', args=[d.arg(name='annotations', type=d.T.object)]),
          withAnnotations(annotations): { spec+: { provider+: { kubernetes+: { envoyService+: { annotations: annotations } } } } },
          '#withAnnotationsMixin':: d.fn(help='"Annotations that should be appended to the service. By default, no annotations are appended."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='annotations', type=d.T.object)]),
          withAnnotationsMixin(annotations): { spec+: { provider+: { kubernetes+: { envoyService+: { annotations+: annotations } } } } },
          '#withExternalTrafficPolicy':: d.fn(help='"ExternalTrafficPolicy determines the externalTrafficPolicy for the Envoy Service. Valid options are Local and Cluster. Default is \\"Local\\". \\"Local\\" means traffic will only go to pods on the node receiving the traffic. \\"Cluster\\" means connections are loadbalanced to all pods in the cluster."', args=[d.arg(name='externalTrafficPolicy', type=d.T.string)]),
          ...
          '#withLoadBalancerClass':: d.fn(help='"LoadBalancerClass, when specified, allows for choosing the LoadBalancer provider implementation if more than one are available or is otherwise expected to be specified"', args=[d.arg(name='loadBalancerClass', type=d.T.string)]),
          withLoadBalancerClass(loadBalancerClass): { spec+: { provider+: { kubernetes+: { envoyService+: { loadBalancerClass: loadBalancerClass } } } } },
          '#withLoadBalancerIP':: d.fn(help='"LoadBalancerIP defines the IP Address of the underlying load balancer service. This field may be ignored if the load balancer provider does not support this feature. This field has been deprecated in Kubernetes, but it is still used for setting the IP Address in some cloud providers such as GCP."', args=[d.arg(name='loadBalancerIP', type=d.T.string)]),
          withLoadBalancerIP(loadBalancerIP): { spec+: { provider+: { kubernetes+: { envoyService+: { loadBalancerIP: loadBalancerIP } } } } },
          '#withType':: d.fn(help='"Type determines how the Service is exposed. Defaults to LoadBalancer. Valid options are ClusterIP, LoadBalancer and NodePort. \\"LoadBalancer\\" means a service will be exposed via an external load balancer (if the cloud provider supports it). \\"ClusterIP\\" means a service will only be accessible inside the cluster, via the cluster IP. \\"NodePort\\" means a service will be exposed on a static Port on all Nodes of the cluster."', args=[d.arg(name='type', type=d.T.string)]),
          withType(type): { spec+: { provider+: { kubernetes+: { envoyService+: { type: type } } } } },
        },
      },
      '#withType':: d.fn(help='"Type is the type of resource provider to use. A resource provider provides infrastructure resources for running the data plane, e.g. Envoy proxy, and optional auxiliary control planes. Supported types are \\"Kubernetes\\"."', args=[d.arg(name='type', type=d.T.string)]),
    ...
    shutdown: {
      '#withDrainTimeout':: d.fn(help="\"DrainTimeout defines the graceful drain timeout. This should be less than the pod's terminationGracePeriodSeconds. If unspecified, defaults to 600 seconds.\"", args=[d.arg(name='drainTimeout', type=d.T.string)]),
      withDrainTimeout(drainTimeout): { spec+: { shutdown+: { drainTimeout: drainTimeout } } },
      '#withMinDrainDuration':: d.fn(help='"MinDrainDuration defines the minimum drain duration allowing time for endpoint deprogramming to complete. If unspecified, defaults to 5 seconds."', args=[d.arg(name='minDrainDuration', type=d.T.string)]),
    ...
    telemetry: {
      ...
      accessLog: {
        ...
        settings: {
          ...
          sinks: {
            ...
            openTelemetry: {
              '#withHost':: d.fn(help='"Host define the extension service hostname."', args=[d.arg(name='host', type=d.T.string)]),
              withHost(host): { openTelemetry+: { host: host } },
              '#withPort':: d.fn(help='"Port defines the port the extension service is exposed on."', args=[d.arg(name='port', type=d.T.integer)]),
              withPort(port): { openTelemetry+: { port: port } },
              '#withResources':: d.fn(help="\"Resources is a set of labels that describe the source of a log entry, including envoy node info. It's recommended to follow [semantic conventions](https://opentelemetry.io/docs/reference/specification/resource/semantic_conventions/).\"", args=[d.arg(name='resources', type=d.T.object)]),
              withResources(resources): { openTelemetry+: { resources: resources } },
              '#withResourcesMixin':: d.fn(help="\"Resources is a set of labels that describe the source of a log entry, including envoy node info. It's recommended to follow [semantic conventions](https://opentelemetry.io/docs/reference/specification/resource/semantic_conventions/).\"\n\n**Note:** This function appends passed data to existing values", args=[d.arg(name='resources', type=d.T.object)]),
        ...
        '#withSettings':: d.fn(help='"Settings defines accesslog settings for managed proxies. If unspecified, will send default format to stdout."', args=[d.arg(name='settings', type=d.T.array)]),
        withSettings(settings): { spec+: { telemetry+: { accessLog+: { settings: if std.isArray(v=settings) then settings else [settings] } } } },
        '#withSettingsMixin':: d.fn(help='"Settings defines accesslog settings for managed proxies. If unspecified, will send default format to stdout."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='settings', type=d.T.array)]),
      ...
      metrics: {
        ...
        sinks: {
          '#openTelemetry':: d.obj(help="\"OpenTelemetry defines the configuration for OpenTelemetry sink. It's required if the sink type is OpenTelemetry.\""),
          openTelemetry: {
            '#withHost':: d.fn(help='"Host define the service hostname."', args=[d.arg(name='host', type=d.T.string)]),
            withHost(host): { openTelemetry+: { host: host } },
            '#withPort':: d.fn(help='"Port defines the port the service is exposed on."', args=[d.arg(name='port', type=d.T.integer)]),
            withPort(port): { openTelemetry+: { port: port } },
          },
          '#withType':: d.fn(help='"Type defines the metric sink type. EG currently only supports OpenTelemetry."', args=[d.arg(name='type', type=d.T.string)]),
          withType(type): { type: type },
        },
        ...
        '#withMatches':: d.fn(help='"Matches defines configuration for selecting specific metrics instead of generating all metrics stats that are enabled by default. This helps reduce CPU and memory overhead in Envoy, but eliminating some stats may after critical functionality. Here are the stats that we strongly recommend not disabling: `cluster_manager.warming_clusters`, `cluster.<cluster_name>.membership_total`,`cluster.<cluster_name>.membership_healthy`, `cluster.<cluster_name>.membership_degraded`，reference  https://github.com/envoyproxy/envoy/issues/9856, https://github.com/envoyproxy/envoy/issues/14610"', args=[d.arg(name='matches', type=d.T.array)]),
      ...
      '#tracing':: d.obj(help='"Tracing defines tracing configuration for managed proxies. If unspecified, will not send tracing data."'),
      tracing: {
        '#provider':: d.obj(help='"Provider defines the tracing provider. Only OpenTelemetry is supported currently."'),
        provider: {
          '#withHost':: d.fn(help='"Host define the provider service hostname."', args=[d.arg(name='host', type=d.T.string)]),
          withHost(host): { spec+: { telemetry+: { tracing+: { provider+: { host: host } } } } },
          '#withPort':: d.fn(help='"Port defines the port the provider service is exposed on."', args=[d.arg(name='port', type=d.T.integer)]),
          withPort(port): { spec+: { telemetry+: { tracing+: { provider+: { port: port } } } } },
          '#withType':: d.fn(help='"Type defines the tracing provider type. EG currently only supports OpenTelemetry."', args=[d.arg(name='type', type=d.T.string)]),
          withType(type): { spec+: { telemetry+: { tracing+: { provider+: { type: type } } } } },
        },
        '#withCustomTags':: d.fn(help='"CustomTags defines the custom tags to add to each span. If provider is kubernetes, pod name and namespace are added by default."', args=[d.arg(name='customTags', type=d.T.object)]),
        withCustomTags(customTags): { spec+: { telemetry+: { tracing+: { customTags: customTags } } } },
        '#withCustomTagsMixin':: d.fn(help='"CustomTags defines the custom tags to add to each span. If provider is kubernetes, pod name and namespace are added by default."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='customTags', type=d.T.object)]),
        withCustomTagsMixin(customTags): { spec+: { telemetry+: { tracing+: { customTags+: customTags } } } },
        '#withSamplingRate':: d.fn(help='"SamplingRate controls the rate at which traffic will be selected for tracing if no prior sampling decision has been made. Defaults to 100, valid values [0-100]. 100 indicates 100% sampling."', args=[d.arg(name='samplingRate', type=d.T.integer)]),
        withSamplingRate(samplingRate): { spec+: { telemetry+: { tracing+: { samplingRate: samplingRate } } } },
      },
    },
    '#withConcurrency':: d.fn(help='"Concurrency defines the number of worker threads to run. If unset, it defaults to the number of cpuset threads on the platform."', args=[d.arg(name='concurrency', type=d.T.integer)]),
    withConcurrency(concurrency): { spec+: { concurrency: concurrency } },
    '#withExtraArgs':: d.fn(help='"ExtraArgs defines additional command line options that are provided to Envoy. More info: https://www.envoyproxy.io/docs/envoy/latest/operations/cli#command-line-options Note: some command line options are used internally(e.g. --log-level) so they cannot be provided here."', args=[d.arg(name='extraArgs', type=d.T.array)]),
    withExtraArgs(extraArgs): { spec+: { extraArgs: if std.isArray(v=extraArgs) then extraArgs else [extraArgs] } },
    '#withExtraArgsMixin':: d.fn(help='"ExtraArgs defines additional command line options that are provided to Envoy. More info: https://www.envoyproxy.io/docs/envoy/latest/operations/cli#command-line-options Note: some command line options are used internally(e.g. --log-level) so they cannot be provided here."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='extraArgs', type=d.T.array)]),
    withExtraArgsMixin(extraArgs): { spec+: { extraArgs+: if std.isArray(v=extraArgs) then extraArgs else [extraArgs] } },
    '#withMergeGateways':: d.fn(help='"MergeGateways defines if Gateway resources should be merged onto the same Envoy Proxy Infrastructure. Setting this field to true would merge all Gateway Listeners under the parent Gateway Class. This means that the port, protocol and hostname tuple must be unique for every listener. If a duplicate listener is detected, the newer listener (based on timestamp) will be rejected and its status will be updated with a \\"Accepted=False\\" condition."', args=[d.arg(name='mergeGateways', type=d.T.boolean)]),
