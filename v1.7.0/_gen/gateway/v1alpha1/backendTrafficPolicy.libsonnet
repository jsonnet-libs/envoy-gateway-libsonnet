{
  ...
  spec: {
    ...
    compression: {
      ...
      withMinContentLength(minContentLength): { minContentLength: minContentLength },
    ...
    loadBalancer: {
      ...
      consistentHash: {
        ...
        withQueryParams(queryParams): { spec+: { loadBalancer+: { consistentHash+: { queryParams: if std.isArray(v=queryParams) then queryParams else [queryParams] } } } },
        ...
        withQueryParamsMixin(queryParams): { spec+: { loadBalancer+: { consistentHash+: { queryParams+: if std.isArray(v=queryParams) then queryParams else [queryParams] } } } },
      ...
      global: {
        ...
        rules: {
          ...
          clientSelectors: {
            ...
            '#queryParams':: d.obj(help='"QueryParams is a list of query parameters to match. Multiple query parameter values are ANDed together,\\nmeaning, a request MUST match all the specified query parameters."'),
            queryParams: {
              '#withInvert':: d.fn(help='"Invert specifies whether the value match result will be inverted.\\nDo not set this field when Type=\\"Distinct\\", implying matching on any/all unique\\nvalues within the query parameter."', args=[d.arg(name='invert', type=d.T.boolean)]),
              withInvert(invert): { invert: invert },
              '#withName':: d.fn(help='"Name of the query parameter."', args=[d.arg(name='name', type=d.T.string)]),
              withName(name): { name: name },
              '#withType':: d.fn(help='"Type specifies how to match against the value of the query parameter."', args=[d.arg(name='type', type=d.T.string)]),
              withType(type): { type: type },
              '#withValue':: d.fn(help='"Value of the query parameter.\\nDo not set this field when Type=\\"Distinct\\", implying matching on any/all unique\\nvalues within the query parameter."', args=[d.arg(name='value', type=d.T.string)]),
              withValue(value): { value: value },
            },
            ...
            '#withQueryParams':: d.fn(help='"QueryParams is a list of query parameters to match. Multiple query parameter values are ANDed together,\\nmeaning, a request MUST match all the specified query parameters."', args=[d.arg(name='queryParams', type=d.T.array)]),
            withQueryParams(queryParams): { queryParams: if std.isArray(v=queryParams) then queryParams else [queryParams] },
            '#withQueryParamsMixin':: d.fn(help='"QueryParams is a list of query parameters to match. Multiple query parameter values are ANDed together,\\nmeaning, a request MUST match all the specified query parameters."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='queryParams', type=d.T.array)]),
          ...
          '#withShadowMode':: d.fn(help='"ShadowMode indicates whether this rate-limit rule runs in shadow mode.\\nWhen enabled, all rate-limiting operations are performed (cache lookups,\\ncounter updates, telemetry generation), but the outcome is never enforced.\\nThe request always succeeds, even if the configured limit is exceeded.\\n\\nOnly supported for Global Rate Limits."', args=[d.arg(name='shadowMode', type=d.T.boolean)]),
          withShadowMode(shadowMode): { shadowMode: shadowMode },
    ...
    '#withCompressor':: d.fn(help='"The compressor config for the http streams.\\nThis provides more granular control over compression configuration.\\nOrder matters: The first compressor in the list is preferred when q-values in Accept-Encoding are equal."', args=[d.arg(name='compressor', type=d.T.array)]),
