{
  ...
  spec: {
    ...
    provider: {
      '#host':: d.obj(help='"Host provides runtime deployment of the data plane as a child process on the\\nhost environment.\\nIf unspecified and type is \\"Host\\", default settings for the custom provider\\nare applied."'),
      host: {
        '#withEnvoyVersion':: d.fn(help='"EnvoyVersion is the version of Envoy to use. If unspecified, the version\\nagainst which Envoy Gateway is built will be used."', args=[d.arg(name='envoyVersion', type=d.T.string)]),
        withEnvoyVersion(envoyVersion): { spec+: { provider+: { host+: { envoyVersion: envoyVersion } } } },
      },
      ...
      kubernetes: {
        ...
        envoyDaemonSet: {
          ...
          container: {
            ...
            '#withImage':: d.fn(help='"Image specifies the EnvoyProxy container image to be used including a tag, instead of the default image.\\nThis field is mutually exclusive with ImageRepository."', args=[d.arg(name='image', type=d.T.string)]),
            withImage(image): { spec+: { provider+: { kubernetes+: { envoyDaemonSet+: { container+: { image: image } } } } } },
            '#withImageRepository':: d.fn(help='"ImageRepository specifies the container image repository to be used without specifying a tag.\\nThe default tag will be used.\\nThis field is mutually exclusive with Image."', args=[d.arg(name='imageRepository', type=d.T.string)]),
            withImageRepository(imageRepository): { spec+: { provider+: { kubernetes+: { envoyDaemonSet+: { container+: { imageRepository: imageRepository } } } } } },
          ...
          pod: {
            ...
            tolerations: {
              ...
              withKey(key): { key: key },
              '#withOperator':: d.fn(help="\"Operator represents a key's relationship to the value.\\nValid operators are Exists, Equal, Lt, and Gt. Defaults to Equal.\\nExists is equivalent to wildcard for value, so that a pod can\\ntolerate all taints of a particular category.\\nLt and Gt perform numeric comparisons (requires feature gate TaintTolerationComparisonOperators).\"", args=[d.arg(name='operator', type=d.T.string)]),
              withOperator(operator): { operator: operator },
            ...
            volumes: {
              ...
              glusterfs: {
                '#withEndpoints':: d.fn(help='"endpoints is the endpoint name that details Glusterfs topology."', args=[d.arg(name='endpoints', type=d.T.string)]),
              ...
              projected: {
                ...
                sources: {
                  ...
                  podCertificate: {
                    ...
                    '#withUserAnnotations':: d.fn(help='"userAnnotations allow pod authors to pass additional information to\\nthe signer implementation.  Kubernetes does not restrict or validate this\\nmetadata in any way.\\n\\nThese values are copied verbatim into the `spec.unverifiedUserAnnotations` field of\\nthe PodCertificateRequest objects that Kubelet creates.\\n\\nEntries are subject to the same validation as object metadata annotations,\\nwith the addition that all keys must be domain-prefixed. No restrictions\\nare placed on values, except an overall size limitation on the entire field.\\n\\nSigners should document the keys and values they support. Signers should\\ndeny requests that contain keys they do not recognize."', args=[d.arg(name='userAnnotations', type=d.T.object)]),
                    withUserAnnotations(userAnnotations): { podCertificate+: { userAnnotations: userAnnotations } },
                    '#withUserAnnotationsMixin':: d.fn(help='"userAnnotations allow pod authors to pass additional information to\\nthe signer implementation.  Kubernetes does not restrict or validate this\\nmetadata in any way.\\n\\nThese values are copied verbatim into the `spec.unverifiedUserAnnotations` field of\\nthe PodCertificateRequest objects that Kubelet creates.\\n\\nEntries are subject to the same validation as object metadata annotations,\\nwith the addition that all keys must be domain-prefixed. No restrictions\\nare placed on values, except an overall size limitation on the entire field.\\n\\nSigners should document the keys and values they support. Signers should\\ndeny requests that contain keys they do not recognize."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='userAnnotations', type=d.T.object)]),
        ...
        envoyDeployment: {
          ...
          container: {
            ...
            '#withImageRepository':: d.fn(help='"ImageRepository specifies the container image repository to be used without specifying a tag.\\nThe default tag will be used.\\nThis field is mutually exclusive with Image."', args=[d.arg(name='imageRepository', type=d.T.string)]),
            withImageRepository(imageRepository): { spec+: { provider+: { kubernetes+: { envoyDeployment+: { container+: { imageRepository: imageRepository } } } } } },
            '#withVolumeMounts':: d.fn(help="\"VolumeMounts are volumes to mount into the container's filesystem.\\nCannot be updated.\"", args=[d.arg(name='volumeMounts', type=d.T.array)]),
          ...
          initContainers: {
            ...
            '#withResizePolicy':: d.fn(help='"Resources resize policy for the container.\\nThis field cannot be set on ephemeral containers."', args=[d.arg(name='resizePolicy', type=d.T.array)]),
          ...
          pod: {
            ...
            '#withPriorityClassName':: d.fn(help='"PriorityClassName indicates the importance of a Pod relative to other Pods.\\nIf a PriorityClassName is not specified, the pod priority will be default or zero if there is no default.\\nMore info: https://kubernetes.io/docs/concepts/scheduling-eviction/pod-priority-preemption/"', args=[d.arg(name='priorityClassName', type=d.T.string)]),
            withPriorityClassName(priorityClassName): { spec+: { provider+: { kubernetes+: { envoyDeployment+: { pod+: { priorityClassName: priorityClassName } } } } } },
            '#withTolerations':: d.fn(help="\"If specified, the pod's tolerations.\"", args=[d.arg(name='tolerations', type=d.T.array)]),
        ...
        envoyHpa: {
          ...
          '#withName':: d.fn(help='"Name of the horizontalPodAutoScaler.\\nWhen unset, this defaults to an autogenerated name."', args=[d.arg(name='name', type=d.T.string)]),
          withName(name): { spec+: { provider+: { kubernetes+: { envoyHpa+: { name: name } } } } },
        },
        ...
        envoyPDB: {
          ...
          '#withName':: d.fn(help='"Name of the podDisruptionBudget.\\nWhen unset, this defaults to an autogenerated name."', args=[d.arg(name='name', type=d.T.string)]),
          withName(name): { spec+: { provider+: { kubernetes+: { envoyPDB+: { name: name } } } } },
        },
        ...
        '#envoyServiceAccount':: d.obj(help='"EnvoyServiceAccount defines the desired state of the Envoy service account resource."'),
        envoyServiceAccount: {
          '#withName':: d.fn(help='"Name of the Service Account.\\nWhen unset, this defaults to an autogenerated name."', args=[d.arg(name='name', type=d.T.string)]),
          withName(name): { spec+: { provider+: { kubernetes+: { envoyServiceAccount+: { name: name } } } } },
        },
      ...
      '#withType':: d.fn(help='"Type is the type of resource provider to use. A resource provider provides\\ninfrastructure resources for running the data plane, e.g. Envoy proxy, and\\noptional auxiliary control planes. Supported types are \\"Kubernetes\\"and \\"Host\\"."', args=[d.arg(name='type', type=d.T.string)]),
    ...
    telemetry: {
      ...
      accessLog: {
        ...
        settings: {
          ...
          format: {
            ...
            '#withType':: d.fn(help='"Type defines the type of accesslog format.\\nWhen unset, both text and json can be specified."', args=[d.arg(name='type', type=d.T.string)]),
              ...
              backendSettings: {
                ...
                connection: {
                  ...
                  preconnect: {
                    ...
                    withPerEndpointPercent(perEndpointPercent): { als+: { backendSettings+: { connection+: { preconnect+: { perEndpointPercent: perEndpointPercent } } } } },
                    ...
                    withPredictivePercent(predictivePercent): { als+: { backendSettings+: { connection+: { preconnect+: { predictivePercent: predictivePercent } } } } },
                  },
                ...
                healthCheck: {
                  ...
                  active: {
                    ...
                    http: {
                      ...
                      withHostname(hostname): { als+: { backendSettings+: { healthCheck+: { active+: { http+: { hostname: hostname } } } } } },
                    ...
                    withInitialJitter(initialJitter): { als+: { backendSettings+: { healthCheck+: { active+: { initialJitter: initialJitter } } } } },
                  ...
                  passive: {
                    ...
                    withFailurePercentageThreshold(failurePercentageThreshold): { als+: { backendSettings+: { healthCheck+: { passive+: { failurePercentageThreshold: failurePercentageThreshold } } } } },
                ...
                loadBalancer: {
                  ...
                  consistentHash: {
                    ...
                    withHeaders(headers): { als+: { backendSettings+: { loadBalancer+: { consistentHash+: { headers: if std.isArray(v=headers) then headers else [headers] } } } } },
                    ...
                    withHeadersMixin(headers): { als+: { backendSettings+: { loadBalancer+: { consistentHash+: { headers+: if std.isArray(v=headers) then headers else [headers] } } } } },
                    ...
                    withQueryParams(queryParams): { als+: { backendSettings+: { loadBalancer+: { consistentHash+: { queryParams: if std.isArray(v=queryParams) then queryParams else [queryParams] } } } } },
                    ...
                    withQueryParamsMixin(queryParams): { als+: { backendSettings+: { loadBalancer+: { consistentHash+: { queryParams+: if std.isArray(v=queryParams) then queryParams else [queryParams] } } } } },
                  ...
                  endpointOverride: {
                    ...
                    withExtractFrom(extractFrom): { als+: { backendSettings+: { loadBalancer+: { endpointOverride+: { extractFrom: if std.isArray(v=extractFrom) then extractFrom else [extractFrom] } } } } },
                    ...
                    withExtractFromMixin(extractFrom): { als+: { backendSettings+: { loadBalancer+: { endpointOverride+: { extractFrom+: if std.isArray(v=extractFrom) then extractFrom else [extractFrom] } } } } },
                  },
                  ...
                  zoneAware: {
                    ...
                    preferLocal: {
                      ...
                      force: {
                        ...
                        withMinEndpointsInZoneThreshold(minEndpointsInZoneThreshold): { als+: { backendSettings+: { loadBalancer+: { zoneAware+: { preferLocal+: { force+: { minEndpointsInZoneThreshold: minEndpointsInZoneThreshold } } } } } } },
                      },
                      ...
                      withMinEndpointsThreshold(minEndpointsThreshold): { als+: { backendSettings+: { loadBalancer+: { zoneAware+: { preferLocal+: { minEndpointsThreshold: minEndpointsThreshold } } } } } },
                      ...
                      withPercentageEnabled(percentageEnabled): { als+: { backendSettings+: { loadBalancer+: { zoneAware+: { preferLocal+: { percentageEnabled: percentageEnabled } } } } } },
                    },
                  },
                },
                ...
                retry: {
                  ...
                  withNumAttemptsPerPriority(numAttemptsPerPriority): { als+: { backendSettings+: { retry+: { numAttemptsPerPriority: numAttemptsPerPriority } } } },
                ...
                timeout: {
                  ...
                  http: {
                    ...
                    withMaxStreamDuration(maxStreamDuration): { als+: { backendSettings+: { timeout+: { http+: { maxStreamDuration: maxStreamDuration } } } } },
            ...
            openTelemetry: {
              ...
              backendSettings: {
                ...
                connection: {
                  ...
                  preconnect: {
                    '#withPerEndpointPercent':: d.fn(help='"PerEndpointPercent configures how many additional connections to maintain per\\nupstream endpoint, useful for high-QPS or latency sensitive services. Expressed as a\\npercentage of the connections required by active streams\\n(e.g. 100 = preconnect disabled, 105 = 1.05x connections per-endpoint, 200 = 2.00×).\\n\\nAllowed value range is between 100-300. When both PerEndpointPercent and\\nPredictivePercent are set, Envoy ensures both are satisfied (max of the two)."', args=[d.arg(name='perEndpointPercent', type=d.T.integer)]),
                    withPerEndpointPercent(perEndpointPercent): { openTelemetry+: { backendSettings+: { connection+: { preconnect+: { perEndpointPercent: perEndpointPercent } } } } },
                    '#withPredictivePercent':: d.fn(help='"PredictivePercent configures how many additional connections to maintain\\nacross the cluster by anticipating which upstream endpoint the load balancer\\nwill select next, useful for low-QPS services. Relies on deterministic\\nloadbalancing and is only supported with Random or RoundRobin.\\nExpressed as a percentage of the connections required by active streams\\n(e.g. 100 = 1.0 (no preconnect), 105 = 1.05× connections across the cluster, 200 = 2.00×).\\n\\nMinimum allowed value is 100. When both PerEndpointPercent and PredictivePercent are\\nset Envoy ensures both are satisfied per host (max of the two)."', args=[d.arg(name='predictivePercent', type=d.T.integer)]),
                    withPredictivePercent(predictivePercent): { openTelemetry+: { backendSettings+: { connection+: { preconnect+: { predictivePercent: predictivePercent } } } } },
                  },
                  '#withBufferLimit':: d.fn(help="\"BufferLimit Soft limit on size of the cluster’s connections read and write buffers.\\nBufferLimit applies to connection streaming (maybe non-streaming) channel between processes, it's in user space.\\nIf unspecified, an implementation defined default is applied (32768 bytes).\\nFor example, 20Mi, 1Gi, 256Ki etc.\\nNote: that when the suffix is not provided, the value is interpreted as bytes.\"", args=[d.arg(name='bufferLimit', type=d.T.any)]),
                ...
                healthCheck: {
                  ...
                  active: {
                    ...
                    http: {
                      ...
                      '#withHostname':: d.fn(help='"Hostname defines the HTTP host that will be requested during health checking.\\nDefault: HTTPRoute or GRPCRoute hostname."', args=[d.arg(name='hostname', type=d.T.string)]),
                      withHostname(hostname): { openTelemetry+: { backendSettings+: { healthCheck+: { active+: { http+: { hostname: hostname } } } } } },
                      '#withMethod':: d.fn(help='"Method defines the HTTP method used for health checking.\\nDefaults to GET"', args=[d.arg(name='method', type=d.T.string)]),
                    ...
                    '#withInitialJitter':: d.fn(help='"InitialJitter defines the maximum time Envoy will wait before the first health check.\\nEnvoy will randomly select a value between 0 and the initial jitter value."', args=[d.arg(name='initialJitter', type=d.T.string)]),
                    withInitialJitter(initialJitter): { openTelemetry+: { backendSettings+: { healthCheck+: { active+: { initialJitter: initialJitter } } } } },
                    '#withInterval':: d.fn(help='"Interval defines the time between active health checks."', args=[d.arg(name='interval', type=d.T.string)]),
                  ...
                  passive: {
                    ...
                    '#withFailurePercentageThreshold':: d.fn(help='"FailurePercentageThreshold sets the failure percentage threshold for outlier detection.\\nIf the failure percentage of a given host is greater than or equal to this value, it will be ejected.\\nDefaults to 85."', args=[d.arg(name='failurePercentageThreshold', type=d.T.integer)]),
                    withFailurePercentageThreshold(failurePercentageThreshold): { openTelemetry+: { backendSettings+: { healthCheck+: { passive+: { failurePercentageThreshold: failurePercentageThreshold } } } } },
                    '#withInterval':: d.fn(help='"Interval defines the time between passive health checks."', args=[d.arg(name='interval', type=d.T.string)]),
                ...
                loadBalancer: {
                  ...
                  consistentHash: {
                    ...
                    '#withHeaders':: d.fn(help='"Headers configures the header hash policy for each header, when the consistent hash type is set to Headers."', args=[d.arg(name='headers', type=d.T.array)]),
                    withHeaders(headers): { openTelemetry+: { backendSettings+: { loadBalancer+: { consistentHash+: { headers: if std.isArray(v=headers) then headers else [headers] } } } } },
                    '#withHeadersMixin':: d.fn(help='"Headers configures the header hash policy for each header, when the consistent hash type is set to Headers."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='headers', type=d.T.array)]),
                    withHeadersMixin(headers): { openTelemetry+: { backendSettings+: { loadBalancer+: { consistentHash+: { headers+: if std.isArray(v=headers) then headers else [headers] } } } } },
                    '#withQueryParams':: d.fn(help='"QueryParams configures the query parameter hash policy when the consistent hash type is set to QueryParams."', args=[d.arg(name='queryParams', type=d.T.array)]),
                    withQueryParams(queryParams): { openTelemetry+: { backendSettings+: { loadBalancer+: { consistentHash+: { queryParams: if std.isArray(v=queryParams) then queryParams else [queryParams] } } } } },
                    '#withQueryParamsMixin':: d.fn(help='"QueryParams configures the query parameter hash policy when the consistent hash type is set to QueryParams."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='queryParams', type=d.T.array)]),
                    withQueryParamsMixin(queryParams): { openTelemetry+: { backendSettings+: { loadBalancer+: { consistentHash+: { queryParams+: if std.isArray(v=queryParams) then queryParams else [queryParams] } } } } },
                    '#withTableSize':: d.fn(help='"The table size for consistent hashing, must be prime number limited to 5000011."', args=[d.arg(name='tableSize', type=d.T.integer)]),
                  ...
                  endpointOverride: {
                    ...
                    '#withExtractFrom':: d.fn(help='"ExtractFrom defines the sources to extract endpoint override information from."', args=[d.arg(name='extractFrom', type=d.T.array)]),
                    withExtractFrom(extractFrom): { openTelemetry+: { backendSettings+: { loadBalancer+: { endpointOverride+: { extractFrom: if std.isArray(v=extractFrom) then extractFrom else [extractFrom] } } } } },
                    '#withExtractFromMixin':: d.fn(help='"ExtractFrom defines the sources to extract endpoint override information from."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='extractFrom', type=d.T.array)]),
                    withExtractFromMixin(extractFrom): { openTelemetry+: { backendSettings+: { loadBalancer+: { endpointOverride+: { extractFrom+: if std.isArray(v=extractFrom) then extractFrom else [extractFrom] } } } } },
                  },
                  '#slowStart':: d.obj(help='"SlowStart defines the configuration related to the slow start load balancer policy.\\nIf set, during slow start window, traffic sent to the newly added hosts will gradually increase.\\nCurrently this is only supported for RoundRobin and LeastRequest load balancers"'),
                  slowStart: {
                    '#withWindow':: d.fn(help='"Window defines the duration of the warm up period for newly added host.\\nDuring slow start window, traffic sent to the newly added hosts will gradually increase.\\nCurrently only supports linear growth of traffic. For additional details,\\nsee https://www.envoyproxy.io/docs/envoy/latest/api-v3/config/cluster/v3/cluster.proto#config-cluster-v3-cluster-slowstartconfig"', args=[d.arg(name='window', type=d.T.string)]),
                  ...
                  zoneAware: {
                    ...
                    preferLocal: {
                      ...
                      force: {
                        '#withMinEndpointsInZoneThreshold':: d.fn(help='"MinEndpointsInZoneThreshold is the minimum number of upstream endpoints in the local zone required to honor the forceLocalZone\\noverride. This is useful for protecting zones with fewer endpoints."', args=[d.arg(name='minEndpointsInZoneThreshold', type=d.T.integer)]),
                        withMinEndpointsInZoneThreshold(minEndpointsInZoneThreshold): { openTelemetry+: { backendSettings+: { loadBalancer+: { zoneAware+: { preferLocal+: { force+: { minEndpointsInZoneThreshold: minEndpointsInZoneThreshold } } } } } } },
                      },
                      '#withMinEndpointsThreshold':: d.fn(help='"MinEndpointsThreshold is the minimum number of total upstream endpoints across all zones required to enable zone-aware routing."', args=[d.arg(name='minEndpointsThreshold', type=d.T.integer)]),
                      withMinEndpointsThreshold(minEndpointsThreshold): { openTelemetry+: { backendSettings+: { loadBalancer+: { zoneAware+: { preferLocal+: { minEndpointsThreshold: minEndpointsThreshold } } } } } },
                      '#withPercentageEnabled':: d.fn(help='"Configures percentage of requests that will be considered for zone aware routing if zone aware routing is configured. If not specified, Envoy defaults to 100%."', args=[d.arg(name='percentageEnabled', type=d.T.integer)]),
                      withPercentageEnabled(percentageEnabled): { openTelemetry+: { backendSettings+: { loadBalancer+: { zoneAware+: { preferLocal+: { percentageEnabled: percentageEnabled } } } } } },
                    },
                  },
                },
                '#proxyProtocol':: d.obj(help='"ProxyProtocol enables the Proxy Protocol when communicating with the backend."'),
                ...
                retry: {
                  ...
                  '#withNumAttemptsPerPriority':: d.fn(help='"NumAttemptsPerPriority defines the number of requests (initial attempt + retries)\\nthat should be sent to the same priority before switching to a different one.\\nIf not specified or set to 0, all requests are sent to the highest priority that is healthy."', args=[d.arg(name='numAttemptsPerPriority', type=d.T.integer)]),
                  withNumAttemptsPerPriority(numAttemptsPerPriority): { openTelemetry+: { backendSettings+: { retry+: { numAttemptsPerPriority: numAttemptsPerPriority } } } },
                  '#withNumRetries':: d.fn(help='"NumRetries is the number of retries to be attempted. Defaults to 2."', args=[d.arg(name='numRetries', type=d.T.integer)]),
                ...
                timeout: {
                  ...
                  http: {
                    ...
                    '#withMaxStreamDuration':: d.fn(help='"MaxStreamDuration is the maximum duration for a stream to complete. This timeout measures the time\\nfrom when the request is sent until the response stream is fully consumed and does not apply to\\nnon-streaming requests.\\nWhen set to \\"0s\\", no max duration is applied and streams can run indefinitely."', args=[d.arg(name='maxStreamDuration', type=d.T.string)]),
                    withMaxStreamDuration(maxStreamDuration): { openTelemetry+: { backendSettings+: { timeout+: { http+: { maxStreamDuration: maxStreamDuration } } } } },
                    '#withRequestTimeout':: d.fn(help='"RequestTimeout is the time until which entire response is received from the upstream."', args=[d.arg(name='requestTimeout', type=d.T.string)]),
              ...
              '#headers':: d.obj(help='"Headers is a list of additional headers to send with OTLP export requests.\\nThese headers are added as gRPC initial metadata for the OTLP gRPC service."'),
              headers: {
              ...
              '#withHeaders':: d.fn(help='"Headers is a list of additional headers to send with OTLP export requests.\\nThese headers are added as gRPC initial metadata for the OTLP gRPC service."', args=[d.arg(name='headers', type=d.T.array)]),
              withHeaders(headers): { openTelemetry+: { headers: if std.isArray(v=headers) then headers else [headers] } },
              '#withHeadersMixin':: d.fn(help='"Headers is a list of additional headers to send with OTLP export requests.\\nThese headers are added as gRPC initial metadata for the OTLP gRPC service."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='headers', type=d.T.array)]),
              withHeadersMixin(headers): { openTelemetry+: { headers+: if std.isArray(v=headers) then headers else [headers] } },
              ...
              '#withResourceAttributes':: d.fn(help="\"ResourceAttributes is a set of labels that describe the source of a log entry, including envoy node info.\\nIt's recommended to follow [semantic conventions](https://opentelemetry.io/docs/reference/specification/resource/semantic_conventions/).\"", args=[d.arg(name='resourceAttributes', type=d.T.object)]),
              withResourceAttributes(resourceAttributes): { openTelemetry+: { resourceAttributes: resourceAttributes } },
              '#withResourceAttributesMixin':: d.fn(help="\"ResourceAttributes is a set of labels that describe the source of a log entry, including envoy node info.\\nIt's recommended to follow [semantic conventions](https://opentelemetry.io/docs/reference/specification/resource/semantic_conventions/).\"\n\n**Note:** This function appends passed data to existing values", args=[d.arg(name='resourceAttributes', type=d.T.object)]),
              withResourceAttributesMixin(resourceAttributes): { openTelemetry+: { resourceAttributes+: resourceAttributes } },
              '#withResources':: d.fn(help="\"Resources is a set of labels that describe the source of a log entry, including envoy node info.\\nIt's recommended to follow [semantic conventions](https://opentelemetry.io/docs/reference/specification/resource/semantic_conventions/).\\n\\nDeprecated: Use ResourceAttributes instead.\"", args=[d.arg(name='resources', type=d.T.object)]),
      ...
      metrics: {
        ...
        prometheus: {
          ...
          compression: {
            ...
            '#withMinContentLength':: d.fn(help='"MinContentLength defines the minimum response size in bytes to apply compression.\\nResponses smaller than this threshold will not be compressed.\\nMust be at least 30 bytes as enforced by Envoy Proxy.\\nNote that when the suffix is not provided, the value is interpreted as bytes.\\nDefault: 30 bytes"', args=[d.arg(name='minContentLength', type=d.T.any)]),
            withMinContentLength(minContentLength): { spec+: { telemetry+: { metrics+: { prometheus+: { compression+: { minContentLength: minContentLength } } } } } },
            ...
            withZstd(zstd): { spec+: { telemetry+: { metrics+: { prometheus+: { compression+: { zstd: zstd } } } } } },
            ...
            withZstdMixin(zstd): { spec+: { telemetry+: { metrics+: { prometheus+: { compression+: { zstd+: zstd } } } } } },
          },
        ...
        sinks: {
          ...
          openTelemetry: {
            ...
            withPort(port): { openTelemetry+: { port: port } },
            '#withReportCountersAsDeltas':: d.fn(help='"ReportCountersAsDeltas configures the OpenTelemetry sink to report\\ncounters as delta temporality instead of cumulative."', args=[d.arg(name='reportCountersAsDeltas', type=d.T.boolean)]),
            withReportCountersAsDeltas(reportCountersAsDeltas): { openTelemetry+: { reportCountersAsDeltas: reportCountersAsDeltas } },
            '#withReportHistogramsAsDeltas':: d.fn(help='"ReportHistogramsAsDeltas configures the OpenTelemetry sink to report\\nhistograms as delta temporality instead of cumulative.\\nRequired for backends like Elastic that drop cumulative histograms."', args=[d.arg(name='reportHistogramsAsDeltas', type=d.T.boolean)]),
            withReportHistogramsAsDeltas(reportHistogramsAsDeltas): { openTelemetry+: { reportHistogramsAsDeltas: reportHistogramsAsDeltas } },
            '#withResourceAttributes':: d.fn(help="\"ResourceAttributes is a set of labels that describe the source of metrics.\\nIt's recommended to follow semantic conventions: https://opentelemetry.io/docs/reference/specification/resource/semantic_conventions/\"", args=[d.arg(name='resourceAttributes', type=d.T.object)]),
            withResourceAttributes(resourceAttributes): { openTelemetry+: { resourceAttributes: resourceAttributes } },
            '#withResourceAttributesMixin':: d.fn(help="\"ResourceAttributes is a set of labels that describe the source of metrics.\\nIt's recommended to follow semantic conventions: https://opentelemetry.io/docs/reference/specification/resource/semantic_conventions/\"\n\n**Note:** This function appends passed data to existing values", args=[d.arg(name='resourceAttributes', type=d.T.object)]),
            withResourceAttributesMixin(resourceAttributes): { openTelemetry+: { resourceAttributes+: resourceAttributes } },
          },
      ...
      tracing: {
        ...
        provider: {
          ...
          backendSettings: {
            ...
            connection: {
              ...
              preconnect: {
                '#withPerEndpointPercent':: d.fn(help='"PerEndpointPercent configures how many additional connections to maintain per\\nupstream endpoint, useful for high-QPS or latency sensitive services. Expressed as a\\npercentage of the connections required by active streams\\n(e.g. 100 = preconnect disabled, 105 = 1.05x connections per-endpoint, 200 = 2.00×).\\n\\nAllowed value range is between 100-300. When both PerEndpointPercent and\\nPredictivePercent are set, Envoy ensures both are satisfied (max of the two)."', args=[d.arg(name='perEndpointPercent', type=d.T.integer)]),
                withPerEndpointPercent(perEndpointPercent): { spec+: { telemetry+: { tracing+: { provider+: { backendSettings+: { connection+: { preconnect+: { perEndpointPercent: perEndpointPercent } } } } } } } },
                '#withPredictivePercent':: d.fn(help='"PredictivePercent configures how many additional connections to maintain\\nacross the cluster by anticipating which upstream endpoint the load balancer\\nwill select next, useful for low-QPS services. Relies on deterministic\\nloadbalancing and is only supported with Random or RoundRobin.\\nExpressed as a percentage of the connections required by active streams\\n(e.g. 100 = 1.0 (no preconnect), 105 = 1.05× connections across the cluster, 200 = 2.00×).\\n\\nMinimum allowed value is 100. When both PerEndpointPercent and PredictivePercent are\\nset Envoy ensures both are satisfied per host (max of the two)."', args=[d.arg(name='predictivePercent', type=d.T.integer)]),
                withPredictivePercent(predictivePercent): { spec+: { telemetry+: { tracing+: { provider+: { backendSettings+: { connection+: { preconnect+: { predictivePercent: predictivePercent } } } } } } } },
              },
              '#withBufferLimit':: d.fn(help="\"BufferLimit Soft limit on size of the cluster’s connections read and write buffers.\\nBufferLimit applies to connection streaming (maybe non-streaming) channel between processes, it's in user space.\\nIf unspecified, an implementation defined default is applied (32768 bytes).\\nFor example, 20Mi, 1Gi, 256Ki etc.\\nNote: that when the suffix is not provided, the value is interpreted as bytes.\"", args=[d.arg(name='bufferLimit', type=d.T.any)]),
            ...
            healthCheck: {
              ...
              active: {
                ...
                http: {
                  ...
                  '#withHostname':: d.fn(help='"Hostname defines the HTTP host that will be requested during health checking.\\nDefault: HTTPRoute or GRPCRoute hostname."', args=[d.arg(name='hostname', type=d.T.string)]),
                  withHostname(hostname): { spec+: { telemetry+: { tracing+: { provider+: { backendSettings+: { healthCheck+: { active+: { http+: { hostname: hostname } } } } } } } } },
                  '#withMethod':: d.fn(help='"Method defines the HTTP method used for health checking.\\nDefaults to GET"', args=[d.arg(name='method', type=d.T.string)]),
                ...
                '#withInitialJitter':: d.fn(help='"InitialJitter defines the maximum time Envoy will wait before the first health check.\\nEnvoy will randomly select a value between 0 and the initial jitter value."', args=[d.arg(name='initialJitter', type=d.T.string)]),
                withInitialJitter(initialJitter): { spec+: { telemetry+: { tracing+: { provider+: { backendSettings+: { healthCheck+: { active+: { initialJitter: initialJitter } } } } } } } },
                '#withInterval':: d.fn(help='"Interval defines the time between active health checks."', args=[d.arg(name='interval', type=d.T.string)]),
              ...
              passive: {
                ...
                '#withFailurePercentageThreshold':: d.fn(help='"FailurePercentageThreshold sets the failure percentage threshold for outlier detection.\\nIf the failure percentage of a given host is greater than or equal to this value, it will be ejected.\\nDefaults to 85."', args=[d.arg(name='failurePercentageThreshold', type=d.T.integer)]),
                withFailurePercentageThreshold(failurePercentageThreshold): { spec+: { telemetry+: { tracing+: { provider+: { backendSettings+: { healthCheck+: { passive+: { failurePercentageThreshold: failurePercentageThreshold } } } } } } } },
                '#withInterval':: d.fn(help='"Interval defines the time between passive health checks."', args=[d.arg(name='interval', type=d.T.string)]),
            ...
            loadBalancer: {
              ...
              consistentHash: {
                ...
                '#withHeaders':: d.fn(help='"Headers configures the header hash policy for each header, when the consistent hash type is set to Headers."', args=[d.arg(name='headers', type=d.T.array)]),
                withHeaders(headers): { spec+: { telemetry+: { tracing+: { provider+: { backendSettings+: { loadBalancer+: { consistentHash+: { headers: if std.isArray(v=headers) then headers else [headers] } } } } } } } },
                '#withHeadersMixin':: d.fn(help='"Headers configures the header hash policy for each header, when the consistent hash type is set to Headers."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='headers', type=d.T.array)]),
                withHeadersMixin(headers): { spec+: { telemetry+: { tracing+: { provider+: { backendSettings+: { loadBalancer+: { consistentHash+: { headers+: if std.isArray(v=headers) then headers else [headers] } } } } } } } },
                '#withQueryParams':: d.fn(help='"QueryParams configures the query parameter hash policy when the consistent hash type is set to QueryParams."', args=[d.arg(name='queryParams', type=d.T.array)]),
                withQueryParams(queryParams): { spec+: { telemetry+: { tracing+: { provider+: { backendSettings+: { loadBalancer+: { consistentHash+: { queryParams: if std.isArray(v=queryParams) then queryParams else [queryParams] } } } } } } } },
                '#withQueryParamsMixin':: d.fn(help='"QueryParams configures the query parameter hash policy when the consistent hash type is set to QueryParams."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='queryParams', type=d.T.array)]),
                withQueryParamsMixin(queryParams): { spec+: { telemetry+: { tracing+: { provider+: { backendSettings+: { loadBalancer+: { consistentHash+: { queryParams+: if std.isArray(v=queryParams) then queryParams else [queryParams] } } } } } } } },
                '#withTableSize':: d.fn(help='"The table size for consistent hashing, must be prime number limited to 5000011."', args=[d.arg(name='tableSize', type=d.T.integer)]),
              ...
              endpointOverride: {
                ...
                '#withExtractFrom':: d.fn(help='"ExtractFrom defines the sources to extract endpoint override information from."', args=[d.arg(name='extractFrom', type=d.T.array)]),
                withExtractFrom(extractFrom): { spec+: { telemetry+: { tracing+: { provider+: { backendSettings+: { loadBalancer+: { endpointOverride+: { extractFrom: if std.isArray(v=extractFrom) then extractFrom else [extractFrom] } } } } } } } },
                '#withExtractFromMixin':: d.fn(help='"ExtractFrom defines the sources to extract endpoint override information from."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='extractFrom', type=d.T.array)]),
                withExtractFromMixin(extractFrom): { spec+: { telemetry+: { tracing+: { provider+: { backendSettings+: { loadBalancer+: { endpointOverride+: { extractFrom+: if std.isArray(v=extractFrom) then extractFrom else [extractFrom] } } } } } } } },
              },
              '#slowStart':: d.obj(help='"SlowStart defines the configuration related to the slow start load balancer policy.\\nIf set, during slow start window, traffic sent to the newly added hosts will gradually increase.\\nCurrently this is only supported for RoundRobin and LeastRequest load balancers"'),
              slowStart: {
                '#withWindow':: d.fn(help='"Window defines the duration of the warm up period for newly added host.\\nDuring slow start window, traffic sent to the newly added hosts will gradually increase.\\nCurrently only supports linear growth of traffic. For additional details,\\nsee https://www.envoyproxy.io/docs/envoy/latest/api-v3/config/cluster/v3/cluster.proto#config-cluster-v3-cluster-slowstartconfig"', args=[d.arg(name='window', type=d.T.string)]),
              ...
              zoneAware: {
                ...
                preferLocal: {
                  ...
                  force: {
                    '#withMinEndpointsInZoneThreshold':: d.fn(help='"MinEndpointsInZoneThreshold is the minimum number of upstream endpoints in the local zone required to honor the forceLocalZone\\noverride. This is useful for protecting zones with fewer endpoints."', args=[d.arg(name='minEndpointsInZoneThreshold', type=d.T.integer)]),
                    withMinEndpointsInZoneThreshold(minEndpointsInZoneThreshold): { spec+: { telemetry+: { tracing+: { provider+: { backendSettings+: { loadBalancer+: { zoneAware+: { preferLocal+: { force+: { minEndpointsInZoneThreshold: minEndpointsInZoneThreshold } } } } } } } } } },
                  },
                  '#withMinEndpointsThreshold':: d.fn(help='"MinEndpointsThreshold is the minimum number of total upstream endpoints across all zones required to enable zone-aware routing."', args=[d.arg(name='minEndpointsThreshold', type=d.T.integer)]),
                  withMinEndpointsThreshold(minEndpointsThreshold): { spec+: { telemetry+: { tracing+: { provider+: { backendSettings+: { loadBalancer+: { zoneAware+: { preferLocal+: { minEndpointsThreshold: minEndpointsThreshold } } } } } } } } },
                  '#withPercentageEnabled':: d.fn(help='"Configures percentage of requests that will be considered for zone aware routing if zone aware routing is configured. If not specified, Envoy defaults to 100%."', args=[d.arg(name='percentageEnabled', type=d.T.integer)]),
                  withPercentageEnabled(percentageEnabled): { spec+: { telemetry+: { tracing+: { provider+: { backendSettings+: { loadBalancer+: { zoneAware+: { preferLocal+: { percentageEnabled: percentageEnabled } } } } } } } } },
                },
              },
            },
            '#proxyProtocol':: d.obj(help='"ProxyProtocol enables the Proxy Protocol when communicating with the backend."'),
            ...
            retry: {
              ...
              '#withNumAttemptsPerPriority':: d.fn(help='"NumAttemptsPerPriority defines the number of requests (initial attempt + retries)\\nthat should be sent to the same priority before switching to a different one.\\nIf not specified or set to 0, all requests are sent to the highest priority that is healthy."', args=[d.arg(name='numAttemptsPerPriority', type=d.T.integer)]),
              withNumAttemptsPerPriority(numAttemptsPerPriority): { spec+: { telemetry+: { tracing+: { provider+: { backendSettings+: { retry+: { numAttemptsPerPriority: numAttemptsPerPriority } } } } } } },
              '#withNumRetries':: d.fn(help='"NumRetries is the number of retries to be attempted. Defaults to 2."', args=[d.arg(name='numRetries', type=d.T.integer)]),
            ...
            timeout: {
              ...
              http: {
                ...
                '#withMaxStreamDuration':: d.fn(help='"MaxStreamDuration is the maximum duration for a stream to complete. This timeout measures the time\\nfrom when the request is sent until the response stream is fully consumed and does not apply to\\nnon-streaming requests.\\nWhen set to \\"0s\\", no max duration is applied and streams can run indefinitely."', args=[d.arg(name='maxStreamDuration', type=d.T.string)]),
                withMaxStreamDuration(maxStreamDuration): { spec+: { telemetry+: { tracing+: { provider+: { backendSettings+: { timeout+: { http+: { maxStreamDuration: maxStreamDuration } } } } } } } },
                '#withRequestTimeout':: d.fn(help='"RequestTimeout is the time until which entire response is received from the upstream."', args=[d.arg(name='requestTimeout', type=d.T.string)]),
          ...
          '#openTelemetry':: d.obj(help='"OpenTelemetry defines the OpenTelemetry tracing provider configuration"'),
          openTelemetry: {
            '#headers':: d.obj(help='"Headers is a list of additional headers to send with OTLP export requests.\\nThese headers are added as gRPC initial metadata for the OTLP gRPC service."'),
            headers: {
              '#withName':: d.fn(help='"Name is the name of the HTTP Header to be matched. Name matching MUST be\\ncase-insensitive. (See https://tools.ietf.org/html/rfc7230#section-3.2).\\n\\nIf multiple entries specify equivalent header names, the first entry with\\nan equivalent name MUST be considered for a match. Subsequent entries\\nwith an equivalent header name MUST be ignored. Due to the\\ncase-insensitivity of header names, \\"foo\\" and \\"Foo\\" are considered\\nequivalent."', args=[d.arg(name='name', type=d.T.string)]),
            ...
            '#withHeaders':: d.fn(help='"Headers is a list of additional headers to send with OTLP export requests.\\nThese headers are added as gRPC initial metadata for the OTLP gRPC service."', args=[d.arg(name='headers', type=d.T.array)]),
            withHeaders(headers): { spec+: { telemetry+: { tracing+: { provider+: { openTelemetry+: { headers: if std.isArray(v=headers) then headers else [headers] } } } } } },
            '#withHeadersMixin':: d.fn(help='"Headers is a list of additional headers to send with OTLP export requests.\\nThese headers are added as gRPC initial metadata for the OTLP gRPC service."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='headers', type=d.T.array)]),
            withHeadersMixin(headers): { spec+: { telemetry+: { tracing+: { provider+: { openTelemetry+: { headers+: if std.isArray(v=headers) then headers else [headers] } } } } } },
            '#withResourceAttributes':: d.fn(help="\"ResourceAttributes is a set of labels that describe the source of traces.\\nIt's recommended to follow semantic conventions: https://opentelemetry.io/docs/reference/specification/resource/semantic_conventions/\"", args=[d.arg(name='resourceAttributes', type=d.T.object)]),
            withResourceAttributes(resourceAttributes): { spec+: { telemetry+: { tracing+: { provider+: { openTelemetry+: { resourceAttributes: resourceAttributes } } } } } },
            '#withResourceAttributesMixin':: d.fn(help="\"ResourceAttributes is a set of labels that describe the source of traces.\\nIt's recommended to follow semantic conventions: https://opentelemetry.io/docs/reference/specification/resource/semantic_conventions/\"\n\n**Note:** This function appends passed data to existing values", args=[d.arg(name='resourceAttributes', type=d.T.object)]),
            withResourceAttributesMixin(resourceAttributes): { spec+: { telemetry+: { tracing+: { provider+: { openTelemetry+: { resourceAttributes+: resourceAttributes } } } } } },
          },
          '#withBackendRefs':: d.fn(help='"BackendRefs references a Kubernetes object that represents the\\nbackend server to which the authorization request will be sent."', args=[d.arg(name='backendRefs', type=d.T.array)]),
          ...
          '#withServiceName':: d.fn(help='"ServiceName defines the service name to use in tracing configuration.\\nIf not set, Envoy Gateway will use a default service name set as\\n\\"name.namespace\\" (e.g., \\"my-gateway.default\\").\\nNote: This field is only supported for OpenTelemetry and Datadog tracing providers.\\nFor Zipkin, the service name in traces is always derived from the Envoy --service-cluster flag\\n(typically \\"namespace/name\\" format). Setting this field has no effect for Zipkin."', args=[d.arg(name='serviceName', type=d.T.string)]),
          withServiceName(serviceName): { spec+: { telemetry+: { tracing+: { provider+: { serviceName: serviceName } } } } },
        ...
        '#spanName':: d.obj(help='"SpanName defines the name of the span which will be used for tracing.\\nEnvoy [command operators](https://www.envoyproxy.io/docs/envoy/latest/configuration/observability/access_log/usage#command-operators) may be used in the value.\\nThe [format string documentation](https://www.envoyproxy.io/docs/envoy/latest/configuration/observability/access_log/usage#config-access-log-format-strings) provides more information.\\n\\nIf not set, the span name is provider specific.\\ne.g. Datadog use `ingress` as the default client span name,\\nand `router <UPSTREAM_CLUSTER> egress` as the server span name."'),
        spanName: {
          '#withClient':: d.fn(help='"Client defines operation name of the span which will be used for tracing."', args=[d.arg(name='client', type=d.T.string)]),
          withClient(client): { spec+: { telemetry+: { tracing+: { spanName+: { client: client } } } } },
          '#withServer':: d.fn(help='"Server defines the operation name of the upstream span which will be used for tracing."', args=[d.arg(name='server', type=d.T.string)]),
          withServer(server): { spec+: { telemetry+: { tracing+: { spanName+: { server: server } } } } },
        },
        '#withCustomTags':: d.fn(help='"CustomTags defines the custom tags to add to each span.\\nIf provider is kubernetes, pod name and namespace are added by default.\\n\\nDeprecated: Use Tags instead."', args=[d.arg(name='customTags', type=d.T.object)]),
        ...
        '#withTags':: d.fn(help='"Tags defines the custom tags to add to each span.\\nEnvoy [command operators](https://www.envoyproxy.io/docs/envoy/latest/configuration/observability/access_log/usage#command-operators) may be used in the value.\\nThe [format string documentation](https://www.envoyproxy.io/docs/envoy/latest/configuration/observability/access_log/usage#config-access-log-format-strings) provides more information.\\nIf provider is kubernetes, pod name and namespace are added by default.\\n\\nSame keys take precedence over CustomTags."', args=[d.arg(name='tags', type=d.T.object)]),
        withTags(tags): { spec+: { telemetry+: { tracing+: { tags: tags } } } },
        '#withTagsMixin':: d.fn(help='"Tags defines the custom tags to add to each span.\\nEnvoy [command operators](https://www.envoyproxy.io/docs/envoy/latest/configuration/observability/access_log/usage#command-operators) may be used in the value.\\nThe [format string documentation](https://www.envoyproxy.io/docs/envoy/latest/configuration/observability/access_log/usage#config-access-log-format-strings) provides more information.\\nIf provider is kubernetes, pod name and namespace are added by default.\\n\\nSame keys take precedence over CustomTags."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='tags', type=d.T.object)]),
        withTagsMixin(tags): { spec+: { telemetry+: { tracing+: { tags+: tags } } } },
      },
    },
    ...
    '#withLuaValidation':: d.fn(help='"LuaValidation determines strictness of the Lua script validation for Lua EnvoyExtensionPolicies\\nDefault: Strict"', args=[d.arg(name='luaValidation', type=d.T.string)]),
    withLuaValidation(luaValidation): { spec+: { luaValidation: luaValidation } },
