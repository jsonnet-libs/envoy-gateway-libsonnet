  ...
  spec: {
    ...
    jsonPatches: {
      ...
      operation: {
        ...
        '#withValue':: d.fn(help='"Value is the new value of the path location."', args=[d.arg(name='value', type=d.T.any)]),
    ...
    '#targetRef':: d.obj(help='"TargetRef is the name of the Gateway API resource this policy is being attached to. Currently only attaching to Gateway is supported This Policy and the TargetRef MUST be in the same namespace for this Policy to have effect and be applied to the Gateway TargetRef"'),
    targetRef: {
